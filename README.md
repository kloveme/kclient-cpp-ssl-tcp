<style>
    .author {
        background-image: url("Github-Assets/wallpaper.png");
        padding: 24px;
        border-radius: 20px;
        display: flex;
        margin: 10px auto;
    ...
    .project-intorduction 
    {
        font-family: Arial, Helvetica, sans-serif;
        font-weight: bold;
        background-image: url("Github-Assets/wallpapr1.png");
        padding: 5px;
        border-radius: 20px;
        background-size: cover;
    ...
    .intorduction-porject_tags {
        display: flex;
        flex-direction: column;
    }
    .intorduction-porject_tags img {
        width: 100%;
        margin-top: 5px;
    }
    .basic_information {
    ...
    .project_api {
        border-radius: 20px;
        background-image: url("Github-Assets/wallpaper2.png");
        padding: 10px;
        background-size: cover;
        width: 600px;
        margin: auto;
...
<br>
<style>
    .code-box{font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    font-weight: bold;padding: 11px; white-space:pre; color: bisque;
    overflow-x: auto;
